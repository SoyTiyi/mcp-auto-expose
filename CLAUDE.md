...
- **Fuente de verdad absoluta:** `.private/documentation.txt`. Consultar SIEMPRE antes de implementar nuevas fases. Cualquier decisión de diseño que contradiga este documento debe rechazarse.
